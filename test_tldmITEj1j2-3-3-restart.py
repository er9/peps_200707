...
fdir = 'j1j2_tldm_data_2site/' #DL_data/'
subdir = ''
...
Ds = [4] # [5] # [4,5,6] #[2,3,4,5,6]
for DMAX in Ds:

  # for XMAX in [100]:  # [25]:

  for J2 in [0.65]: #[0.7,0.6]: # [0.65,0.7,0.6]:  #[0., 0.1, 0.5, 1.0]: #,0.05,0.25]:
    ...
    # for target_beta in [0.5,1.0,1.5,2.0,3.0,5.0,7.5]: # 10.0,15.0]:
        ...
        if do_FU:
            ...
            if save_data:
                ...
                try:
                    ...
                    np.savetxt(fdir+subdir+file_str+'_FU_X%d_beta%s_data.txt'%(XMAX,beta_str_0),np.real(np.array(FU_data)).T,header=header_str)
