...
restart = True
# restart_beta = 2.0  # beta/2 * 2
# target_betas = [1.5,2.0,3.0,5.0,7.5] #10.0,15.0]:  # beta/2
...
for DMAX in Ds:
  ...
  for J2 in [0.7]:  #[0.3,0.35,0.4]: #,0.05,0.25]:
        ...
        if do_FU:
            ...
            if save_data:
                ...
                try:
                    ...
                    np.savetxt(fdir+subdir+file_str+'_FU_X%d_data_restart-2.txt'%(XMAX),np.real(np.array(FU_data)).T,header=header_str)
