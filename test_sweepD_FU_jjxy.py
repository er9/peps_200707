...
if True:
    ...
    # fdir = 'jjxy_data/'
    # fdir = 'F_jjxy_data_test/'
    fdir = 'jjxy_swap_test/nnn/'
    subdir = 'Ds_data/'
    ...
    for DMAX in [2]:  #[3,4,5,6]:
        ...
        for hx in [0.]:     # [0.,0.05,0.25]:
            ...
            for J2 in [0.7]:  # np.linspace(0,1,11):
                ...
                try:
                    time2a = time.time()
                    obs_t2a, pepx2 = TE_GL.run_TE(dt2, totT2, trotterH, initPEPS_GL, DMAX=DMAX, XMAX=XMAX, XMAX2=XMAX2,
                                                  obs_pepos=obs_pepos,te_type='FU',qr_reduce=do_QR, contract_SL=do_SL,scaleX=1)
